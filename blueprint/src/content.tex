...
\begin{definition}
    ...
    \uses{thm:bitwise_test_power_of_two,thm:next_to_xor_pow_two}
...
\begin{theorem}
    ...
    %\lean{pow_two_complement_induction}
...
\begin{theorem}
    ...
    %\lean{list_gray_code_correctness}
    \uses{def:list_gray_code,def:gray_code}

    Each list $L_n$ is a gray code on $\mathbb{Z} / 2^n \mathbb{Z}$.
\end{theorem}

\begin{proof}
    \uses{thm:next_to_xor_pow_two}
...
\begin{theorem}
    ...
    %\lean{recursive_gray_code_correctness}
...
\begin{proof}
    \uses{thm:list_gray_code_correctness,thm:list_is_recursive}
...
\begin{theorem}
    ...
    \uses{def:gray_code,def:recursive_gray_code}
